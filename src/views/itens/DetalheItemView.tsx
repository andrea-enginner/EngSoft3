      ...
      <div className="grid items-start gap-8 lg:grid-cols-[1.15fr_.85fr] lg:gap-12">
        ...
        <div className="space-y-6">
          <section>
            ...
            {item.valorCentavos ? <p className="mt-4 text-xl font-bold text-primary-700">{new Intl.NumberFormat("pt-BR", { style: "currency", currency: "BRL" }).format(item.valorCentavos / 100)}</p> : null}
